...
export const
    INIT_EVENTS_REQUEST = `${prefix}/INIT_EVENTS_REQUEST`,
...
export const eventsListSelector = createSelector(stateSelector, state => state.eventList)
export const activeEventSelector = createSelector(stateSelector, state => state.activeEvent)
export const activeEventNameSelector = createSelector(activeEventSelector, state => state.name)
export const activeEventConditionsSelector = createSelector(activeEventSelector, state => state.conditions)
export const activeEventEffectsSelector = createSelector(activeEventSelector, state => state.effects)
export const activeEventIsCompletedSelector = createSelector(activeEventSelector, state => state.isCompleted)
...
export const addEventToList = event => ({type: CREATE_EVENT_REQUEST, payload: event})
export const removeEventFromList = eventName => ({type: REMOVE_EVENT_REQUEST, payload: eventName})
export const setActiveEvent = event => ({type: SET_ACTIVE_EVENT_REQUEST, payload: event})
export const changeActiveEvent = event => ({type: CHANGE_ACTIVE_EVENT_REQUEST, payload: event})
export const changeEventCompleteStatus = isComplete => ({type: COMPLETE_ACTIVE_EVENT_REQUEST, payload: isComplete})
