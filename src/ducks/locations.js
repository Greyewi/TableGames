...
export const activeLocationNameSelector = createSelector(
  activeLocationSelector,
  state => state.name
)
export const activeLocationMovementsSelector = createSelector(
  activeLocationSelector,
  state => state.movements
)
export const activeLocationEventsSelector = createSelector(
  activeLocationSelector,
  state => state.events
)
export const activeLocationMapSelector = createSelector(
  activeLocationSelector,
  state => state.map
)
export const activeLocationMusicSelector = createSelector(
  activeLocationSelector,
  state => state.backMusic
)
