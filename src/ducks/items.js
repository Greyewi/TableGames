...
export const
    INIT_ITEMS_DATA_REQUEST = `${prefix}/INIT_ITEMS_DATA_REQUEST`,
...
export const itemsListSelector = createSelector(stateSelector, state => state.itemsList)
export const activeItemSelector = createSelector(stateSelector, state => state.activeItem)
export const nameItemSelector = createSelector(activeItemSelector, state => state.name)
export const costItemSelector = createSelector(activeItemSelector, state => state.cost)
export const isUniqueItemSelector = createSelector(activeItemSelector, state => state.isUnique)
export const typeItemSelector = createSelector(activeItemSelector, state => state.type)
export const effectItemSelector = createSelector(activeItemSelector, state => state.effect)
export const placeItemSelector = createSelector(activeItemSelector, state => state.place)
...
export const setActiveItem = item => ({type: SET_ACTIVE_ITEM_REQUEST, payload: item})
export const changeActiveItem = item => ({type: CHANGE_ACTIVE_ITEM_REQUEST, payload: item})
